...
IdPais INT CONSTRAINT FK_PersPaises FOREIGN KEY (IdPais)
REFERENCES Paises(IdPais),
Sexo INT CONSTRAINT FK_SexoPaises FOREIGN KEY (Sexo)
...
INSERT INTO Sexos VALUES(3, 'Otros');
GO
